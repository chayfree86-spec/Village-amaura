                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-slate-450 mt-1 flex items-center gap-1.5">
                                  ...
                                  {m.status === 1 && (
                                    <span className="w-1.5 h-1.5 rounded-full bg-natureGreen inline-block shadow-[0_0_4px_rgba(46,125,50,0.5)]"></span>
                                  )}
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="flex items-center gap-3 mt-2">
                            ...
                            <a
                              ...
                              className={`${currentUser ? 'w-10 h-10 flex-shrink-0' : 'w-full h-10 gap-1.5'} bg-natureGreen/10 hover:bg-natureGreen/25 text-natureGreen border border-natureGreen/25 rounded-xl flex items-center justify-center transition-colors`}
                              title="कॉल करें"
                            >
                              ...
                              {!currentUser && (
                                <span className="text-xs font-semibold transform translate-y-[1.5px]">कॉल करें</span>
                              )}
                            </a>
                          </div>
                        </div>
